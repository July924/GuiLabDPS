...
import styles from "./page.module.css"; const Equipos = ({ equipos }) => { return (
  ...
  {"id": 2,"nombre": "Barcelona","plantilla":[
    ...
    {"id": 3,"nombre": "Manchester City","plantilla":[
      {"id": 1,"nombre":"Erling Haaland","Altura":"1.94","Peso":"88Kg"},
      {"id": 2,"nombre":"Kevin de Bruyne","Altura":"1.81","Peso":"68Kg"},
      {"id": 3,"nombre":"Ruben Dias","Altura":"1.87","Peso":"76Kg"}
      ]}
